...
dos2unix "${COMPOSE_DIR}/scripts/initiate_replica.sh"
chmod ugo+x "${COMPOSE_DIR}/scripts/initiate_replica.sh"
...
COMPOSE_FILES+=" -f ${COMPOSE_DIR}/web.yml"
